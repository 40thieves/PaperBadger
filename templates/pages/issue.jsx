...
export default class Issue extends Component {
  ...
  componentWillMount() {
    ...
    this.loadClaimFromServer(this.props.params.slug);
  }
            ...
            <fieldset>
              ...
              <div className="pure-controls">
                <CheckboxGroup name="badges" ref="badges">
                  ...
                  <div>Management activities to annotate (produce metadata), scrub data and maintain research data
                    (including software code, where it is necessary for interpreting the data itself) for initial use
                    and later re-use.
                  </div>
                  <label>
                    <input value="formal_analysis" type="checkbox"/> Formal analysis
                  </label>
                  <div>Application of statistical, mathematical, computational, or other formal techniques to analyse or
                  ...
                  <div>Conducting a research and investigation process, specifically performing the experiments, or
                  ...
                  <div>Management and coordination responsibility for the research activity planning and execution.
                  </div>
                  <label><input value="resources" type="checkbox"/> Resources </label>
                  <div>Provision of study materials, reagents, materials, patients, laboratory samples, animals,
                    instrumentation, computing resources, or other analysis tools.
                  </div>
                  <label><input value="software" type="checkbox"/> Software </label>
                  <div>Programming, software development; designing computer programs; implementation of the computer
                  ...
                  <div>Oversight and leadership responsibility for the research activity planning and execution,
                    including mentorship external to the core team.
                  </div>
                  <label><input value="validation" type="checkbox"/> Validation </label>
                  <div>Verification, whether as a part of the activity or separate, of the overall
                  ...
                  <div>Preparation, creation and/or presentation of the published work, specifically visualization/data
                    presentation.
                  </div>
                  <label><input value="writing_initial" type="checkbox"/> Writing - original draft </label>
                  <div>Preparation, creation and/or presentation of the published work, specifically writing the initial
                    draft (including substantive translation).
                  </div>
                  <label><input value="writing_review" type="checkbox"/> Writing - review & editing </label>
                  <div>Preparation, creation and/or presentation of the published work by those from the original
